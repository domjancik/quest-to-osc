...
@onready var osc_sender: OSCClient = $OSCSender
...
func _process(delta):
	...
	osc_sender.send_message("/controller/xyz", [position.x, position.y, position.z])
	#osc_sender.send_message("/controller/a"), [right_hand.is_button_pressed("a")])
	#osc_sender.send_messaged("/controller/A"), [right_hand.is_button_pressed("A")])
	#osc_sender.send_message("/controller/b"), [right_hand.is_button_pressed("b")])
	#osc_sender.send_message("/controller/B"), [right_hand.is_button_pressed("B")])
